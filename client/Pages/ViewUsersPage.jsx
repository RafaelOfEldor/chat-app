...
export default function ViewUsersPage() {
  ...
  async function handleDirectMessageChat(receivingUserId, receivingUserUsername) {
    ...
    if (res.ok) {
      ...
      if (isDm) {
        navigate(`/chatrooms/room/${roomId}`, {state: {prevUrl: location.pathname}});
      } else {
        const newRoom = {
        ...
        if (!res.ok) {
          ...
          navigate(`/chatrooms/room/${newRoom.id}`, {state: {prevUrl: location.pathname}});
        }
      }
      ...
      <div style={{height: "60px", marginTop: "3px"}} key={index}>
        ...
        <div className="select-user-profile-card nohover">
          ...
          <div className="user-element">
                ...
                onClick={() => navigate(`/profile`, {state: {prevUrl: location.pathname}})}
                >
                  Go to profile  
                </button>
                </div>
